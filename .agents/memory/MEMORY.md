...
- [project] Medusa AI tools integration (MCP + Plugin) and learning guide → tech-decisions.md
- [customer] Customer Module Notion technical documentation architecture (5 Phases) → tech-decisions.md
